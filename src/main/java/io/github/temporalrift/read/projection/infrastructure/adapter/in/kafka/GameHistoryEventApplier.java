...
class GameHistoryEventApplier {
    ...
    // Records HandSelected (the terminal five-card hand), not HandDealt (game-service#121/#127's pending
    // seven-card offer) -- history must reflect what the player actually ended up with, whether they chose it
    // or the hand-selection timer's random default resolved it for them.
